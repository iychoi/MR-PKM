 ...
 * @author iychoi
 */
public class KmerFrequencyComparisonIndexSplit extends InputSplit implements Writable {

    private Path[] indexPaths;
    private KmerRangePartition partition;

    public KmerFrequencyComparisonIndexSplit() {    
    }
    
    public KmerFrequencyComparisonIndexSplit(Path[] indexFilePaths, KmerRangePartition partition) {
