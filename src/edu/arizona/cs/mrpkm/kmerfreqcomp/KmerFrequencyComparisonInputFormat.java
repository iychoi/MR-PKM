 ...
 * @author iychoi
 */
public class KmerFrequencyComparisonInputFormat extends SequenceFileInputFormat<CompressedSequenceWritable, KmerFrequencyComparisonResult> {

    private static final Log LOG = LogFactory.getLog(KmerFrequencyComparisonInputFormat.class);

    private final static String NUM_INPUT_FILES = "mapreduce.input.num.files";
    
    @Override
    public RecordReader<CompressedSequenceWritable, KmerFrequencyComparisonResult> createRecordReader(InputSplit split, TaskAttemptContext context) throws IOException {
        return new KmerFrequencyComparisonRecordReader();
    }
    
    public static void setInputFormatConfig(JobContext job, KmerFrequencyComparisonInputFormatConfig inputFormatConfig) {
    ...
    public List<InputSplit> getSplits(JobContext job) throws IOException {
        ...
        for(KmerRangePartition partition : partitions) {
            splits.add(new KmerFrequencyComparisonIndexSplit(indexFilePaths, partition));
        }
